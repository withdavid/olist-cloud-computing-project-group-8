...
push-images: ## push docker images to custom docker registry
	...
	# cd ../ms_products
	# docker build -t us-west1-docker.pkg.dev/olist-cloud/olist-containers/ms_products_api:latest .
	# docker push us-west1-docker.pkg.dev/olist-cloud/olist-containers/ms_products_api:latest

	# cd ../ms_orders
	# docker build -t us-west1-docker.pkg.dev/olist-cloud/olist-containers/ms_orders_api:latest .
